...
// ============================================
// RUTAS P├â┼íBLICAS (sin autenticaci├â┬│n)
// ============================================
...
// Rutas p├â┬║blicas de razones de rechazo
Route::get('/rejection-reasons', [RejectionReasonController::class, 'index']);

// Env├â┬¡o de mensajes (p├â┬║blico, pero puede incluir user_id si est├â┬í autenticado)
Route::post('/messages', [MessageController::class, 'store']);

// Env├â┬¡o de contactos (p├â┬║blico, pero puede incluir user_id si est├â┬í autenticado)
Route::post('/contacts', [ContactController::class, 'store']);

// ============================================
// RUTAS PROTEGIDAS (requieren autenticaci├â┬│n con Sanctum)
// ============================================
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Rutas de categor├â┬¡as (CRUD completo - solo admin)
    ...
    // Rutas de comentarios/rese├â┬▒as
    ...
    Route::prefix('company')->group(function () {
        ...
        // Gesti├│n de reservas desde la perspectiva de la empresa
    ...
    // ============================================
    // RUTAS DE ADMIN API (requieren autenticaci├â┬│n + admin)
    // ============================================
    Route::prefix('admin')->middleware('admin')->group(function () {
        ...
        Route::put('/places/{place}', [AdminPlaceController::class, 'update']); // Mantener PUT tambi├â┬®n por compatibilidad
