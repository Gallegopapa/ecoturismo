...
class PlaceController extends Controller
{
    ...
    public function show(Request $request, Place $place): JsonResponse
    {
        ...
        // Calcular rating promedio (Mutilado)
        $averageRating = 0; // $place->reviews->avg('rating') ?? 0;
        $reviewsCount = 0; // $place->reviews->count();

        // Cargar TODAS las reservas futuras del lugar (Mutilado)
        $futureReservations = []; // \App\Models\Reservation::...
