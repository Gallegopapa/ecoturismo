...
class ReviewController extends Controller
{
    ...
    /**
     * Normaliza aliases comunes de la calificaci├│n para evitar p├®rdida de datos.
     */
    ...
    /**
     * Obtener todas las rese├▒as (p├║blico)
     */
    ...
    // Obtener rese├▒as de un lugar o ecohotel
    public function index(Request $request, $type, $id): JsonResponse
    {
        if ($type === 'place') {
            ...
            return response()->json(['message' => 'Tipo inv├ílido'], 400);
        }
    ...
    // Crear rese├▒a para lugar o ecohotel
    public function store(Request $request): JsonResponse
    {
        ...
        $messages = [
            ...
            'rating.required' => 'La calificaci├│n es obligatoria.',
            'rating.integer' => 'La calificaci├│n debe ser un n├║mero.',
            'rating.min' => 'La calificaci├│n m├¡nima es 1.',
            'rating.max' => 'La calificaci├│n m├íxima es 5.',
     ...
     * - El administrador no edita aqu├¡; puede eliminar cualquier rese├▒a
     */
    public function update(Request $request, Review $review): JsonResponse
    {
        ...
        // Opcional: actualizar fecha de comentario al momento de la edici├│n
    ...
    public function destroy(Request $request, Review $review): JsonResponse
    {
        ...
        // El autor puede eliminar su rese├▒a.
        // El administrador puede eliminar cualquier rese├▒a.
