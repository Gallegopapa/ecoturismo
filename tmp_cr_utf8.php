...
class CompanyReservationController extends Controller
{
    ...
    public function reject(Request $request, CompanyReservation $companyReservation): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'rejection_reason_id.required' => 'La raz├│n de rechazo es requerida.',
            'rejection_reason_id.exists' => 'La raz├│n de rechazo seleccionada no existe.',
    ...
    /**
     * Obtener estad├¡sticas de reservas para un lugar
     */
    ...
    /**
     * Obtener estad├¡sticas globales de reservas para la empresa
     */
